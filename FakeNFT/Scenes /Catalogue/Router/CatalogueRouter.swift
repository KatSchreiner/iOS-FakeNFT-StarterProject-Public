...
protocol CatalogueRouterProtocol {
    func navigateToDetail(with collection: CatalogueNFTCollection, service: CatalogueService, view: CollectionView, router: CollectionRouterProtocol)
...
final class CatalogueRouter: CatalogueRouterProtocol {
    ...
    func navigateToDetail(
        with collection: CatalogueNFTCollection,
